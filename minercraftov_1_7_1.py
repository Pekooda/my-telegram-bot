...
## Реакция на полный текст
    if message.text:
        ...
        if message.text.lower() == "кобо":
            await message.answer("Действительно гуманизированный умный голос (НА МЕНЯ НАКРИЧАЛ ОДИН ЧЕЛОВЕК ЧТО Я ОДНУ ФРАЗУ СДЕЛАЛ НА УКРАИНСКОМ ИБО ОДНАЖДЫ ЭТОТ ЧЕЛОВЕК СДЕЛАЛ ПЕРЕВОД ТЕКСТА И ВСЁ, МНЕ НЕЛЬЗЯ СЛАТЬ НА УКРАИНСКОМ =|)")
